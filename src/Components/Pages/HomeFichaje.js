...
export default function HomeFichaje() {
  const data = [
  ...
  const [isFocus, setIsFocus] = useState(false);
    return (
      <View style={styles.containerfichajes}>
        <Text style={styles.hourfichaje}>08:05 am</Text>
        <View style={styles.boxfichajes}>
          <Text style={styles.titlefichaje}>¡Hola, Pepito!</Text>
          <AppButton 
            onPress={() => Alert.alert('Iniciar fichaje.')}
            title='INICIAR FICHAJE'
            styles={styles.fichaje_btn}
            />
            <Text style={styles.textfichaje}>No has iniciado fichaje hoy</Text>
